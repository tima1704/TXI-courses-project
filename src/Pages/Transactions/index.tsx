                                                  ...
                                                  : transactArray.map(item => {
                                                       return (
                                                            <tr>
                                                                 ...
                                                                 <td className={styles["lastdate_table"]}>{item.lastdate}</td>
                                                                 <td className={styles["status_table"]}>{item.status}</td>
                                                       ...
                                                       <div className={styles["element_transaction"]}>
                                                            <div className={styles["top_content"]}>
                                                                 ...
                                                                 <div className={styles["price_content"]}>
                                                                      <div>
                                                                           <span>Стоимость</span>
                                                                           <p className={styles["priceMobile"]}>{item.price}</p>
                                                                      </div>
                                                                      <div>
                                                                           <span>Истекает</span>
                                                                           <p>{item.lastdate}</p>
                                                            ...
                                                            <div className={styles["bottom_content"]}>
                                                                 ...
                                                                 <div className={styles["status_item"]}>
                                                                      <div>
                                                                           <span>Статус</span>
                                                                           <p className={styles["status_item_text"]}>{item.status}</p>
                                                                      </div>
                                                                 </div>
                                                            </div>
                                                       </div>
